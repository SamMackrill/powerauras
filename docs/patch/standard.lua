-- /usr/share/lua/5.1/luadoc/taglet/standard.lua
...
function parse_file (filepath, doc)
	...
	if summary then
		doc.files[filepath].author = summary.author
		doc.files[filepath].copyright = summary.copyright
		doc.files[filepath].description = summary.description
		doc.files[filepath].release = summary.release
		doc.files[filepath].summary = summary.summary
	end
...
-- /usr/share/lua/5.1/luadoc/doclet/html/index.lp