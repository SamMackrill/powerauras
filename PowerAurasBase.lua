...
PowaAuras.DebuffTypeSpellIds={
	...
	[91797] = PowerAuras.DebuffCatType.Stun,    -- Monstrous Blow (for unholy DK ghouls under Dark Transformation)
	[91802] = Powerauras.DebuffCatType.Root,	-- Shambling Rush (for unholy DK ghouls under Dark Transformation)
	-- Druid
