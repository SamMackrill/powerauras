...
PowaAuras:MergeTables(PowaAuras.Text, 
{
	...
	UI_Aura_SrcNorm_ErrGeneric = "There was an error loading the texture:\n\n%s",
	UI_Aura_SrcCustom_ErrNoTex = "You have not assigned a custom texture to this page yet. Use the textbox below and enter the file name of your custom texture.\n\nCustom textures are being loaded from:\n%s",
