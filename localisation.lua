...
PowaAuras:MergeTables(PowaAuras.Text, 
{
	...
	TernaryYes = {
		...
		FiveMan= "Only when in a 5-Man instance",
		Raid= "Only when in a Raid instance",
		Bg= "Only when in a Battleground",
		Arena= "Only when in an Arena instance",
	},
	TernaryNo = {
		...
		FiveMan= "Only when Not in a 5-Man instance",
		Raid= "Only when Not in a Raid instance",
		Bg= "Only when Not in a Battleground",
		Arena= "Only when Not in an Arena instance",
	},
	TernaryAide = {
		...
		FiveMan= "Effect modified by being in a 5-Man instance",
		Raid= "Effect modified by being in a Raid instance",
		Bg= "Effect modified by being in a Battleground",
		Arena= "Effect modified by being in an Arena instance",
	},
