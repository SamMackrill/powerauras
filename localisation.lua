...
PowaAuras:MergeTables(PowaAuras.Text, 
{
	...
	UI_Aura_TexLockDesc        = "Locks your auras in place, preventing you from moving your auras by dragging them.",
	UI_Aura_TexUnlock          = "Unlock",
	UI_Aura_TexUnlockDesc      = "Unlocks your auras, allowing you to move them around by dragging the auras.",
