...
PowaAuras:MergeTables(PowaAuras.Text, 
{
	...
	Ternary = {
		...
		isAlive= "Alive",
		PvP= "PvP flag set",
		FiveManInstance= "5-Man",
		RaidInstance= "Raid",
		BgInstance= "Battleground",
		ArenaInstance= "Arena",
	},
	...
	TernaryYes = {
		...
		FiveManInstance= "Only when in a 5-Man instance",
		RaidInstance= "Only when in a Raid instance",
		BgInstance= "Only when in a Battleground",
		ArenaInstance= "Only when in an Arena instance",
	},
	TernaryNo = {
		...
		FiveManInstance= "Only when Not in a 5-Man instance",
		RaidInstance= "Only when Not in a Raid instance",
		BgInstance= "Only when Not in a Battleground",
		ArenaInstance= "Only when Not in an Arena instance",
	},
	TernaryAide = {
		...
		FiveManInstance= "Effect modified by being in a 5-Man instance",
		RaidInstance= "Effect modified by being in a Raid instance",
		BgInstance= "Effect modified by being in a Battleground",
		ArenaInstance= "Effect modified by being in an Arena instance",
	},
	...
	nomReasonNotInFiveManInstance = "Not in 5-Man Instance",
	nomReasonInFiveManInstance = "In 5-Man Instance",		
	nomReasonNotInRaidInstance = "Not in Raid Instance",
	nomReasonInRaidInstance = "In Raid Instance",		
	nomReasonNotInBattlegroundInstance = "Not in Battleground Instance",
	nomReasonInBattlegroundInstance = "In Battleground Instance",		
