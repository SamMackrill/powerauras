...
PowaAuras:MergeTables(PowaAuras.Text, 
{
	...
	aideUnitMatch = "Enter the name of the unit that needs to be targetted to activate this aura. You can use units like \"player\" or \"pet\" to detect anything which targets you or your pet.",
