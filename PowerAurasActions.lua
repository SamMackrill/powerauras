...
function cPowaAuraSizeAction:Set(value)
	PowaAuras:SetFrameSize(self.Parameters.Frame, self.Parameters.Aura, self.Parameters.Texture, value, self.Parameters.Aura.torsion, (self.Parameters.Aura.SourceType == PowaAuras.SourceTypes.Text), self.Parameters.Aura.aurastextfont)
end
